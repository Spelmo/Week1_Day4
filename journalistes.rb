...
# ranger les journalistes par ordre alphabétique > les noms qui commencent par _ sont affichés en premier car _ est avant le a en ASCII
def alphasorting(journatweet)
  return journatweet.sort_by!{|journalists| journalists.downcase}
end
